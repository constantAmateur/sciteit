...
const char _modtable[] = "sciteit_rel_vote_account_link";
const char _vote_select[] = "select thing1_id as u, thing2_id as a, case when name = '1' then 1 else -1 end as b from sciteit_rel_vote_account_link where name != '0'";
