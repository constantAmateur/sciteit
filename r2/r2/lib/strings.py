...
string_dict = dict(
    ...
    read_only_msg = _("This is a backup server, intended only to be used when sciteit is down or undergoing maintenance.  You can only read things here, you will not be able to login.  Click [here](http://sciteit.com) to return to the main website."),
