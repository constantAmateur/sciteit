...
time psql -F"\t" -A -t -d newsciteit -U $USER -h $LINKDBHOST \
     -c "\\copy (select d.thing_id, 'data', 'link',
                  ...
                  where d.key = 'url' ) to 'sciteit_data_link.dump'"
cat sciteit_data_link.dump sciteit_thing_link.dump | sort -T. -S200m | paster --plugin=r2 run $INI r2/lib/migrate/mr_domains.py -c "join_links()" > links.joined
