...
#defining types
class Link(Thing):
    _int_props = Thing._int_props + ('num_comments','num_criticisms')
...
#t = thing.Things(sciteit.Account, name='spez')
#r = thing.Relations(sciteit.Friend)
# s = Relations(Subsciteit)
...
#items in programming.sciteit by spez
#join(s, a, s.thing2_id == a.thing2_id)

#create of instances
#link = Link()
#link.url = 'http://sciteit.com'
